...
# /home/chenzy/mmpretrain/mmpretrain/apis/model.py
from mmpretrain import ImageClassificationInferencer
# /home/chenzy/mmpretrain/mmpretrain/apis/image_classification.py
import os 
...
inferencer = ImageClassificationInferencer('/home/chenzy/mmpretrain/configs/resnet/resnet101_8xb16_sea_trash.py', pretrained='/home/chenzy/mmpretrain/work_dirs/resnet101_8xb16_sea_trash/epoch_200.pth')
...
for i in tqdm(range(len(lable_file_list))):
    try:
        ...
        error_count+= 1
        error_list.append(lable_file_list[i])

    label_file =  open(label_file_path,'r')
    new_label_file =  open(new_lable_txt_file,'a')
    for lines in label_file.readlines()[-1:]:
        # print(lines)
        # img_shape = str(lines[-1])
        # new_lable_txt_file = output_lable + '/'+ lable_file_list[i]
        # new_label_file =  open(new_lable_txt_file,'a')
        new_label_file.write(lines)
